...
function App() {
  ...
  //useref hook for copy text and give reference to input

  const passwordRef = useRef(null)

  //length,numberAllowed,charAllowed and set password ko bar bar call karne ke liye usecallback hooks ka use karna hai
